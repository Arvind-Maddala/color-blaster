 ...
 //Creating a Player and adjusting at center
...
//Creating Projectile and adding event listener
...
let projectile = new Projectile(canvas.width / 2, canvas.height / 2, 5, 'red', {x:1,y:1});
let projectiles = [];
let enemies = []
let particles = []
